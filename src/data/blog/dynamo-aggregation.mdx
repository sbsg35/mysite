...
tags: ['DynamoDB', 'AWS', 'Serverless framework']
...
For the record, I would just use relational database, but I wanted to learn a
bit more about Dynamo.
  ...
  <table class='w-full text-sm text-left text-gray-500 dark:text-gray-400'>
    ...
    <tbody>
      <tr class='bg-white border-b dark:bg-gray-800 dark:border-gray-700'>
        <td class='px-6 py-4'>123-2023-05</td>
        <td class='px-6 py-4'>123</td>
        <td class='px-6 py-4'>5</td>
        <td class='px-6 py-4'>2023-05</td>
      </tr>
      <tr class='bg-white border-b dark:bg-gray-800 dark:border-gray-700'>
        <td class='px-6 py-4'>124-2023-05</td>
        <td class='px-6 py-4'>124</td>
        <td class='px-6 py-4'>11</td>
        <td class='px-6 py-4'>2023-05</td>
      </tr>
      <tr class='bg-white border-b dark:bg-gray-800 dark:border-gray-700'>
        <td class='px-6 py-4'>125-2023-05</td>
...
However this is not possible in DynamoDB.

One way to achieve this is with [DynamoDB Streams](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Streams.html).
...
3. Every time a user adds a new traprecord, we run a lambda function to update
   this table based on the event type (UPDATE, CREATE, DELETE).

Here is what the `traprecord-monthly` table might look like if we aggregated the above data.
...
I use the [Serverless framework](https://www.serverless.com/). It's a wrapper around CloudFormation which makes it very easy
...
Great now all we have to do is set up a lambda function to fire whenever there is
