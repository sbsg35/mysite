...
This goes without saying, if you have complex queries, you should consider using a relational database like PostgreSQL or MySQL.

## Background

I was working on a proof of concept pest tracker software for a local volunteer group. The choice of database was dynamodb (although relational database would have been better).
